          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
            <div className="text-white max-w-2xl">
              <h1 className="text-4xl lg:text-6xl font-bold mb-4">
                Quality Motorcycle Parts for Pakistan
              </h1>
              <p className="text-xl mb-8 text-gray-200">
                Discover thousands of genuine and aftermarket parts for 70CC, 100CC, and 125CC motorcycles. 
                Fast delivery across Pakistan, expert support, guaranteed quality.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Find the perfect parts for your motorcycle. We stock genuine and aftermarket parts for all popular Pakistani motorcycle brands.
            </p>
          </div>
